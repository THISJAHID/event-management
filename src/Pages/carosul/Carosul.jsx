        ...
        <Slider {...settings}>
          <div>
            <div className="img w-[100px]  justify-center">
              ...
              <img className='rounded-full' src="https://scontent.fdac144-1.fna.fbcdn.net/v/t31.18172-1/22384087_10154819682976891_5369315647445272063_o.jpg?stp=dst-jpg_p200x200&_nc_cat=109&ccb=1-7&_nc_sid=0222cc&_nc_ohc=GLu07HJ_1AsAX-rxThX&_nc_ht=scontent.fdac144-1.fna&oh=00_AfB9WdWEwOKvXvjPcc-CCqOWLAP9mb5sK_GBSvpDjK4OtQ&oe=655220F0" alt="" />
              <div className="title">
                <h2 className='text-center'>Jhonkar Mahbub</h2>
                <span className='text-center'>CEO</span>

              </div>
              <div className='text-2xl flex gap-4'>
                <a href='https://www.facebook.com/groups/245345291436418/user/686386890/' className='hover:text-[#6457e0]'><FaFacebook></FaFacebook> </a >
                <button className='hover:text-[#6457e0]'><TiSocialTwitter></TiSocialTwitter> </button>
                <button className='hover:text-[#6457e0]'><AiFillLinkedin></AiFillLinkedin> </button>
              </div>
            </div>
          </div>
          <div>
            <div className="img w-[100px]  justify-center">
              ...
              <div className="title">
                <h2 className='text-center'>Azizul Islam </h2>
                <span className='text-center'>Web Instrutor</span>

              </div>
              <div className='text-2xl flex gap-4'>
                <a href='https://www.facebook.com/groups/245345291436418/user/100095521570378/' className=''><FaFacebook></FaFacebook> </a>
          ...
          <div>
            <div className="img w-[100px]  justify-center">
              ...
              <div className="title">
                <h2 className='text-center'>Md. Hasib</h2>
                <span className='text-center'>web Instrutor</span>

              </div>
              <div className='text-2xl flex gap-4'>
                <a href='https://www.facebook.com/groups/245345291436418/user/100057186924469' className='hover:text-[#6457e0]'><FaFacebook></FaFacebook> </a>
                <button className='hover:text-[#6457e0]'><TiSocialTwitter></TiSocialTwitter> </button>
                <button className='hover:text-[#6457e0]'><AiFillLinkedin></AiFillLinkedin> </button>
              </div>
            </div>
          ...
          <div>
            <div className="img w-[100px]  justify-center">
              ...
              <div className="title">
                <h2 className='text-center'>Faisal</h2>
                <span className='text-center'>web Instrutor</span>

              </div>
              <div className='text-2xl flex gap-4'>
                <a href='https://www.facebook.com/groups/245345291436418/user/100095521570378/' className='hover:text-[#6457e0]'><FaFacebook></FaFacebook> </a >
                <button className='hover:text-[#6457e0]'><TiSocialTwitter></TiSocialTwitter> </button>
                <button className='hover:text-[#6457e0]'><AiFillLinkedin></AiFillLinkedin> </button>
              </div>
            </div>
          ...
          <div>
            <div className="img w-[100px]  justify-center">
              ...
              <div className="title">
                <h2 className='text-center'>Ryan Samuel</h2>
                <span className='text-center'>Co-Founder</span>

              </div>
              <div className='text-2xl flex gap-4'>
                <button className='hover:text-[#6457e0]'><FaFacebook></FaFacebook> </button>
                <button className='hover:text-[#6457e0]'><TiSocialTwitter></TiSocialTwitter> </button>
                <button className='hover:text-[#6457e0]'><AiFillLinkedin></AiFillLinkedin> </button>
              </div>
            </div>
