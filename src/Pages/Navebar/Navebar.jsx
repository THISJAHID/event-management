...
const Navebar = () => {
   ...
   console.log(user)
    ...
    return (
        <div>
            <nav className="sticky inset-0 z-10 block h-max w-full max-w-full rounded-none border border-white/80 bg-[#ffffff] bg-opacity-80 py-2 px-4 text-white shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
           ...
           <Link to="/"  className="mr-4 block cursor-pointer py-1.5 font-sans text-base font-medium leading-relaxed text-inherit antialiased">
                        <img className='w-36' src="https://i.postimg.cc/FKqnLjFv/captivatingevents-logo-e1630311137443.png" alt="" />
                    </Link>
